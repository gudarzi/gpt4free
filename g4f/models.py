...
groq_gemma_7b_it = Model(
    name="gemma-7b-it",
    base_provider="openai",
    best_provider=Groq
)
groq_distil_whisper_large_v3_en = Model(
    name="distil-whisper-large-v3-en",
    base_provider="openai",
    best_provider=Groq
)
groq_gemma2_9b_it = Model(
    name="gemma2-9b-it",
    base_provider="openai",
    best_provider=Groq
)
...
groq_llama3_groq_70b_8192_tool_use_preview = Model(
    name="llama3-groq-70b-8192-tool-use-preview",
    base_provider="openai",
    best_provider=Groq
)
groq_llama3_groq_8b_8192_tool_use_preview = Model(
    name="llama3-groq-8b-8192-tool-use-preview",
    base_provider="openai",
    best_provider=Groq
)
groq_llama_3_1_70b_versatile = Model(
    name="llama-3.1-70b-versatile",
    base_provider="openai",
    best_provider=Groq
)
groq_llama_3_1_8b_instant = Model(
    name="llama-3.1-8b-instant",
    base_provider="openai",
    best_provider=Groq
)
groq_llama_guard_3_8b = Model(
    name="llama-guard-3-8b",
    base_provider="openai",
    best_provider=Groq
)
groq_llama3_70b_8192 = Model(
    name="llama3-70b-8192",
    base_provider="openai",
    best_provider=Groq
)
groq_llama3_8b_8192 = Model(
    name="llama3-8b-8192",
    base_provider="openai",
    best_provider=Groq
)
groq_whisper_large_v3 = Model(
...
mixtral_8x7b = Model(
    ...
    best_provider=IterListProvider(
        [DeepInfra, HuggingFace, PerplexityLabs, HuggingChat, DDG, ReplicateHome])
)
